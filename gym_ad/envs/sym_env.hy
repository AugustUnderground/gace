...
(defclass UnSymmetricalAmplifier [SingleEndedOpAmpEnv]
  ...
  (defn __init__ [self &optional ^str [pdk-path None] ^str [ckt-path None] 
    ...
    ;; Initialize parent Environment.
    (.__init__ (super UnSymmetricalAmplifier self) 
               AmplifierID.SYMMETRICAL 
               [pdk-path] ckt-path
               nmos-path pmos-path
               max-moves
...
(defclass UnSymAmpXH035Env [UnSymmetricalAmplifier]
  """
  Symmetrical Amplifier in XH035 Technology.
  """
...
(defclass UnSymAmpXH035GeomEnv [UnSymAmpXH035Env]
  """
  Un-Symmetrical Amplifier in XH035 Technology with geometrical action space.
  """
  ...
  (defn __init__ [self &optional ^str [pdk-path None] ^str [ckt-path None] 
    ...
    (.__init__ (super UnSymAmpXH035GeomEnv self) :pdk-path pdk-path 
                                               :ckt-path ckt-path
                                               :max-moves max-moves 
                                               :random-target random-target
                                               :target target 
