...
(defclass NAND4XH018V3Env [NAND4Env]
  """
  Implementation: xh018-1V8
  """
  (defn __init__ [self &kwargs kwargs]
    (.__init__ (super NAND4XH018V3Env self) #**
...
(defclass NAND4XT018V3Env [NAND4Env]
  """
  Implementation: xt018-1V8
  """
  (defn __init__ [self &kwargs kwargs]
    (.__init__ (super NAND4XT018V3Env self) #**
...
(defclass NAND4SKY130V3Env [NAND4Env]
  """
  Implementation: sky130-1V8
  """
  (defn __init__ [self &kwargs kwargs]
    (.__init__ (super NAND4SKY130V3Env self) #**
...
(defclass NAND4GPDK180V3Env [NAND4Env]
  """
  Implementation: gpdk180-1V8
  """
  (defn __init__ [self &kwargs kwargs]
    (.__init__ (super NAND4GPDK180V3Env self) #**
